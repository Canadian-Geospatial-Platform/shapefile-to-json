...
import requests, zipfile, StringIO, arcpy, os
...
if __name__ == '__main__':
    ...
    arcpy.CreateFileGDB_management(out_folder_path=workspace, out_name=Geodatabase_name, out_version="CURRENT")
    ...
    for SHP in Shapefiles:
        ...
        arcpy.FeatureClassToFeatureClass_conversion(in_features=Shapefile, out_path=Geodatabase, out_name=BaseName, where_clause="", field_mapping="", config_keyword="")
    ...
    #
    arcpy.AddField_management(in_table=ShapefileAll, field_name="VERTICES", field_type="FLOAT", field_precision="255", field_scale="0", field_length="", field_alias="", field_is_nullable="NULLABLE", field_is_required="NON_REQUIRED", field_domain="")
    ...
    # GeoCore
    #
    arcpy.FeaturesToJSON_conversion(in_features=ShapefileAll, out_json_file="C:/TEMP/IPN_FeaturesToJSON.json", format_json="FORMATTED", include_z_values="NO_Z_VALUES", include_m_values="NO_M_VALUES", geoJSON="GEOJSON")
